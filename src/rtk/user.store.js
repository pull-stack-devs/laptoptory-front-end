...
const approvedAPI = 'https://pull-stack-laptoptory.herokuapp.com/users/approve/'
...
export const updateUsers = createAsyncThunk('users/updateUsers', async (item) => {
  ...
  export const acceptUsers = createAsyncThunk('users/acceptUsers', async (item) => {
    console.log("items>>>>>>>", item)
    await axios({
        method: 'post',
  ...
  export const deleteUsers = createAsyncThunk('users/deleteUsers', async (item) => {
    console.log("items>>>>>>>", item)
    await axios({
        method: 'delete',
        url: api,
