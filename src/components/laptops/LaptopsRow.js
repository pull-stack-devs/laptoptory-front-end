  ...
  const columns = [
    ...
    },
    {
      ...
      getValue: ({ value, column }) =>
        value ? `Assigned to ${value}` : 'Not Assigned',
      disabled: false,
    },
    {
      id: '11',
  ...
  return (
    <>
      <form className={classes.root} noValidate autoComplete="off">
        ...
        >
          <DialogTitle id="alert-dialog-title">
            {'Return a student laptop to the inventory:'}
          </DialogTitle>
          <DialogContent>
            <DialogContentText
              id="alert-dialog-description"
